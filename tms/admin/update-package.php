...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails,services=:pservices where PackageId=:pid";
...
$query->bindParam(':pservices',$pservices,PDO::PARAM_STR);
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="services" id="services" placeholder="services" required><?php echo htmlentities($result->services);?></textarea> 
									</div>
								</div>															
<div class="form-group">
