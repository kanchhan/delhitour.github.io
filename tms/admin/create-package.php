...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,services,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pservices,:pimage)";
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="services" id="services" placeholder="services" required></textarea> 
									</div>
								</div>														
<div class="form-group">
