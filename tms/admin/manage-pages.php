  ...
  <div class="grid-form1">
  	       <h3>Update Page Data</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="manage-pages.php?type=about delhi">about Delhi</option> 
                  <option value="manage-pages.php?type=contact">Contact us</option>
				  <option value="manage-pages.php?type=travelwithindelhi">travel within Delhi</option>
                </select>
									</div>
								</div>
<div class="form-group">
			...
			switch($_GET['type'])
			{
				...
				case "contact" :
									echo "Contact Us";
									break;
				case "travelwithindelhi" :
									echo "travel in delhi";
									break;
