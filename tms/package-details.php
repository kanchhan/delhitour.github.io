...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>timing</b> <?php echo htmlentities($result->PackageFetures);?></p> 
				
				<p><b>Services :</b><?php echo htmlentities($result->services);?></p>
		...
		<h2>Package Details</h2>
				...
				<p><b><?php echo htmlentities($result->PackageDetails);?></b></p>
					...
					<button type="submit" name="submit2" class="btn-primary btn">Book</button>
						...
						<?php } else {?>
							<li class="sigi" align="center" style="margin-top: 1%">
							 ...
							 <a href="#" data-toggle="modal" data-target="#myModal" class="btn-primary btn"> book</a></li> 
							<?php } ?>
